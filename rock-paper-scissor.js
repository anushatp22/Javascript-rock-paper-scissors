...
function eve() {
    ...
    else if ((computerMove === 'Scissor' & finalValue === 'Paper') | (computerMove === 'Rock' & finalValue === 'Scissor')) {
        result += 'lose';
        finalResult += 'You lose';
        message += (`You chose ${finalValue}. Computer chose ${computerMove}. You ${result}`);
    }
    else if ((computerMove === 'Rock' & finalValue === 'Paper') | (computerMove === 'Scissor' & finalValue === 'Paper') | (computerMove === 'Scissor' & finalValue === 'Rock')) {
        result += 'win';
        finalResult += 'You win';
        message += (`You chose ${finalValue}. Computer chose ${computerMove}. You ${result}`);
    }
